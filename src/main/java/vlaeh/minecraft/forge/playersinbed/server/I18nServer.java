...
public class I18nServer implements I18nProxy {
    ...
    private final void loadProperties(final String name) {
        final String fileName = "/assets/playerinbed/lang/" + name + ".lang";
        try {
            ...
            if (in != null) {
                ...
                System.err.println("PlayerInBed: resource file '" + fileName + "' not found");
        } catch (Exception e) {
    ...
    public void load(final String lang) {
        ...
        if (properties.isEmpty()) {
            System.err.println("PlayerInBed .lang files not found");
        }
    }
